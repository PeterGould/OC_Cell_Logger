...
try {
		Debug.PushSubsStack("ble_CharacteristicChanged (bt_controller) ","bt_controller",6,__ref.getField(false, "ba"),__ref,110);
...
Debug.locals.put("Characteristic", _characteristic);
 BA.debugLineNum = 110;BA.debugLine="Sub ble_CharacteristicChanged (Characteristic As B";
Debug.ShouldStop(8192);
 BA.debugLineNum = 111;BA.debugLine="Log(\"Read -> \" & Characteristic.GetStringValue(0)";
...
try {
		Debug.PushSubsStack("ble_Connected (bt_controller) ","bt_controller",6,__ref.getField(false, "ba"),__ref,90);
...
Debug.locals.put("Services", _services);
 BA.debugLineNum = 90;BA.debugLine="Sub ble_Connected (Services As Map)";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 91;BA.debugLine="If ConnectState = cstatePreConnect Then";
...
__ref.getField(false,"_readcharacteristic").setObject (__ref.getField(false,"_bleservice").runMethod(false,"GetCharacteristics").runMethod(false,"GetValueAt",(Object)(BA.numberCast(int.class, 0))));
 BA.debugLineNum = 96;BA.debugLine="Manager.ReadCharacteristic(readCharacteristic";
Debug.ShouldStop(-2147483648);
__ref.getField(false,"_manager").runVoidMethod ("ReadCharacteristic",(Object)(__ref.getField(false,"_readcharacteristic")));
 BA.debugLineNum = 97;BA.debugLine="Manager.SetCharacteristicNotification(readCha";
Debug.ShouldStop(1);
__ref.getField(false,"_manager").runVoidMethod ("SetCharacteristicNotification",(Object)(__ref.getField(false,"_readcharacteristic")),(Object)(bt_controller.__c.getField(true,"True")));
 BA.debugLineNum = 98;BA.debugLine="writeCharacteristic = bleService.GetCharacter";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("ble_DeviceFound (bt_controller) ","bt_controller",6,__ref.getField(false, "ba"),__ref,51);
...
Debug.locals.put("MacAddress", _macaddress);
 BA.debugLineNum = 51;BA.debugLine="Sub ble_DeviceFound (Name As String, MacAddress As";
Debug.ShouldStop(262144);
 BA.debugLineNum = 53;BA.debugLine="Log(\"found BT \" & Name)";
Debug.ShouldStop(1048576);
bt_controller.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("found BT "),_name)));
 BA.debugLineNum = 54;BA.debugLine="If Name.SubString2(0,4) = \"SODA\" Then";
...
if (RemoteObject.solveBoolean("=",_name.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 4))),BA.ObjectToString("SODA"))) { 
 BA.debugLineNum = 55;BA.debugLine="listBLEDevicesName.Add(Name)";
Debug.ShouldStop(4194304);
__ref.getField(false,"_listbledevicesname").runVoidMethod ("Add",(Object)((_name)));
 BA.debugLineNum = 56;BA.debugLine="listBLEDevicesMacAdress.Add(MacAddress)";
...
try {
		Debug.PushSubsStack("ble_Disconnected (bt_controller) ","bt_controller",6,__ref.getField(false, "ba"),__ref,102);
if (RapidSub.canDelegate("ble_disconnected")) return __ref.runUserSub(false, "bt_controller","ble_disconnected", __ref);
 BA.debugLineNum = 102;BA.debugLine="Sub ble_Disconnected";
Debug.ShouldStop(32);
 BA.debugLineNum = 103;BA.debugLine="ConnectState = cstateDisconnect";
Debug.ShouldStop(64);
__ref.setField ("_connectstate",__ref.getField(true,"_cstatedisconnect"));
 BA.debugLineNum = 104;BA.debugLine="Manager.refreshDeviceCache";
Debug.ShouldStop(128);
__ref.getField(false,"_manager").runVoidMethod ("refreshDeviceCache");
 BA.debugLineNum = 105;BA.debugLine="Manager.Close";
...
try {
		Debug.PushSubsStack("ble_DiscoveryFinished (bt_controller) ","bt_controller",6,__ref.getField(false, "ba"),__ref,60);
if (RapidSub.canDelegate("ble_discoveryfinished")) return __ref.runUserSub(false, "bt_controller","ble_discoveryfinished", __ref);
int _i = 0;
 BA.debugLineNum = 60;BA.debugLine="Sub ble_DiscoveryFinished";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 61;BA.debugLine="Log(\"Search finished\")";
Debug.ShouldStop(268435456);
bt_controller.__c.runVoidMethod ("Log",(Object)(RemoteObject.createImmutable("Search finished")));
 BA.debugLineNum = 62;BA.debugLine="If(listBLEDevicesName.Size) = 0 Then";
Debug.ShouldStop(536870912);
if (RemoteObject.solveBoolean("=",(__ref.getField(false,"_listbledevicesname").runMethod(true,"getSize")),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 63;BA.debugLine="scan_status = -1";
Debug.ShouldStop(1073741824);
__ref.setField ("_scan_status",BA.numberCast(int.class, -(double) (0 + 1)));
 BA.debugLineNum = 64;BA.debugLine="Log(\"No Devices Found\")";
Debug.ShouldStop(-2147483648);
bt_controller.__c.runVoidMethod ("Log",(Object)(RemoteObject.createImmutable("No Devices Found")));
 }else {
 BA.debugLineNum = 66;BA.debugLine="scan_status = listBLEDevicesName.Size";
Debug.ShouldStop(2);
__ref.setField ("_scan_status",__ref.getField(false,"_listbledevicesname").runMethod(true,"getSize"));
 BA.debugLineNum = 67;BA.debugLine="For i = 0 To scan_status - 1";
Debug.ShouldStop(4);
{
final int step57 = 1;
final int limit57 = RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_scan_status"),RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
for (_i = 0; (step57 > 0 && _i <= limit57) || (step57 < 0 && _i >= limit57); _i = ((int)(0 + _i + step57))) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 68;BA.debugLine="Log(\"found \" & listBLEDevicesName.Get(i))";
Debug.ShouldStop(8);
...
;
 ...
 BA.debugLineNum = 72;BA.debugLine="connect_a_device(0)";
Debug.ShouldStop(128);
...
try {
		Debug.PushSubsStack("connect_a_device (bt_controller) ","bt_controller",6,__ref.getField(false, "ba"),__ref,76);
...
Debug.locals.put("device_position", _device_position);
 BA.debugLineNum = 76;BA.debugLine="Sub connect_a_device(device_position As Int)";
Debug.ShouldStop(2048);
 BA.debugLineNum = 77;BA.debugLine="If ConnectState = cstateDisconnect Then";
...
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_connectstate"),BA.numberCast(double.class, __ref.getField(true,"_cstatedisconnect")))) { 
 BA.debugLineNum = 78;BA.debugLine="ConnectState = cstatePreConnect";
Debug.ShouldStop(8192);
__ref.setField ("_connectstate",__ref.getField(true,"_cstatepreconnect"));
 BA.debugLineNum = 79;BA.debugLine="pass_message = listBLEDevicesName.Get(device_pos";
Debug.ShouldStop(16384);
__ref.setField ("_pass_message",BA.ObjectToString(__ref.getField(false,"_listbledevicesname").runMethod(false,"Get",(Object)(_device_position))));
 BA.debugLineNum = 80;BA.debugLine="Manager.Connect(listBLEDevicesMacAdress.Get(devi";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("connectBT (bt_controller) ","bt_controller",6,__ref.getField(false, "ba"),__ref,39);
...
bt_controller.__c.runVoidMethod ("Log",(Object)(RemoteObject.createImmutable("Searching devices...")));
 BA.debugLineNum = 48;BA.debugLine="ToastMessageShow( \"Searching devices...\" ,True)";
Debug.ShouldStop(32768);
bt_controller.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToString("Searching devices...")),(Object)(bt_controller.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("disconnect_a_device (bt_controller) ","bt_controller",6,__ref.getField(false, "ba"),__ref,85);
if (RapidSub.canDelegate("disconnect_a_device")) return __ref.runUserSub(false, "bt_controller","disconnect_a_device", __ref);
 BA.debugLineNum = 85;BA.debugLine="Sub disconnect_a_device";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 86;BA.debugLine="Manager.Disconnect";
Debug.ShouldStop(2097152);
__ref.getField(false,"_manager").runVoidMethod ("Disconnect");
...
try {
		Debug.PushSubsStack("Initialize (bt_controller) ","bt_controller",6,__ref.getField(false, "ba"),__ref,21);
